...
if all_data:
    ...
    df[years] = df[years].astype(float) # convert to float, type was object. To compute the "std"
    df['Standard_deviation'] = df[years].std(axis=1, numeric_only=True).round(3)#axis = 1  to compute std to row-wise
